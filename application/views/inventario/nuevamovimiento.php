                     ...
                     <table width="662" border="0" id="tabpag">
                     	<thead>
                            <tr>
                                ...
                                <td style="border-width: 0px; ">Producto</td>
                                <td style="border-width: 0px; ">Presentacion</td>
                                <td style="border-width: 0px; ">Fecha vencimiento</td>
                                <td style="border-width: 0px; ">Fecha movimiento</td>
                                <td style="border-width: 0px; ">Cantidad</td>
                                <td style="border-width: 0px; ">estado</td>
                                <td style="border-width: 0px; ">Movimiento</td>
                            </tr>
                         </thead>
                         <tbody>
                            <?php
                                foreach ($Listar as $Valor) {
                                	$rutaact= "nuevamovimiento/actualizarprodact/".$Valor['id'];
                            ?>
                          		<tr>
