                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="border-width: 0px; "><label for="txtnuevaindpais"></label>
                                    <?php echo form_input($nomcargo); ?></td>
                     ...
                     <table width="662" border="0" id="tabpag">
                     	<thead>
                            <tr>
                                ...
                                <td style="border-width: 0px; ">ID</td>
                                <td style="border-width: 0px; ">Descripcion cargo</td>
                            </tr>
                         </thead>
                         <tbody>
                            <?php
                            ...
                            ?>
                          		<tr>
                                     ...
                                     <td style="border-width: 0px; "> <?php echo $Valor['nomcargo'] ?> </td>
